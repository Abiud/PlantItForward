...
import 'package:plant_it_forward/ui/auth/login/login_viewmodel.dart';
...
class LoginView extends StatelessWidget with $LoginView {
  ...
  LoginView({Key? key, required this.toggleView}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Image(
                        image: AssetImage('assets/PIF-Logo-removebg_10.png'),
                        width: screenWidth(context) < 720
                            ? screenHeightFraction(context) / 2
                            : 330,
                      ),
                    ),
                  ),
                  ...
                  Form(
                    child: Column(
                      children: [
                        ...
                        //   onChangedFn: (val) => _fireFormChanged(model),
                        // ),
                        TextFormField(
                        ...
                        //       : null,
                        //   onChangedFn: (val) => _fireFormChanged(model),
                        //   onFieldSubmittedFn: (val) => model.saveData(),
                        // ),
                      ],
                    ),
                  ),
