...
class AvailableFarmer extends StatefulWidget {
  const AvailableFarmer({Key? key}) : super(key: key);

  @override
  _AvailableFarmerState createState() => _AvailableFarmerState();
}

class _AvailableFarmerState extends State<AvailableFarmer> {
